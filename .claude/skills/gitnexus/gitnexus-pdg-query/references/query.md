...
Use the anchored `pdg_query` tool for guard discovery. For custom Cypher, bind a file/function anchor and LIMIT before inspecting CDG edges; branch sense is stored in `reason`.
